...
function shadeTriIsect(isect,isectSphere,lights,triangles,spheres) {
    try {
        if (   !(isect instanceof Object) || !(typeof(isectSphere) === "number")
            ...
            for (var l=0; l<lights.length; l++) {
                ...
                if (!isLightOccluded(L,isect.xyz,1,spheres,false)) {
                    ...
                    // a = new Vector(triangles.vertices[0][0],triangles[isectSphere].vertices[0][1],triangles[isectSphere].vertices[0][2]);
                   // 	b= new Vector(triangles.vertices[1][0],triangles.vertices[1][1],triangles[isectSphere].vertices[1][2]);
                   // 	c = new Vector(triangles.vertices[2][0],triangles.vertices[2][1],triangles[isectSphere].vertices[2][2]);
                   // 	var ab = Vector.subtract(b,a);
                   // 	var ac = Vector.subtract(c,a);
            ...
            var integral_c = new Color(0,0,0,255);
            ...
            c[2] += integral_c[2]; // clamp max value to 1
